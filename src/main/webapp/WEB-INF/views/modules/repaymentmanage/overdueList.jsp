...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("#confirm").click(function(){
      ...
      $("#searchForm").attr("action","${ctx}/repayment/OverdueManage/toRepayment");
      $("#searchForm").submit();
    });
...
<body>
  <ul class="nav nav-tabs">
    <li class="active"><a href="###">逾期列表</a></li>
  </ul>
  <form id="searchForm" modelAttribute="overdueVO" action="${ctx}/repayment/OverdueManage/toPuList" method="post" class="breadcrumb form-search">
    ...
    <div style="margin-top:8px;overflow:hidden">
      ...
      <input id="advanceBatch" class="btn btn-info" type="button" value="批量垫付" style="display: block;float:right;"/>
    </div>
  </form>
