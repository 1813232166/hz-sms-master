...
<body>
	...
	<form:form id="searchForm" modelAttribute="tExitSettings" action="${ctx}/exitmanage/tExitSettings/exitAuditList" method="post" class="breadcrumb form-search" cssStyle="height: 36px;">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="tExitSettings" varStatus="status" >
			<tr>
		        ...
		        <td>
		            <a href="${ctx}/exitmanage/tExitSettings/form?id=${tExitSettings.id}">查看</a>
				</td>
			</tr>
		 </c:forEach> 
