    				...
    				if(holderType=="some")
    					{
    				 		...
    				 		var singletonUser= $("#singletonUser").val();
...
<body>
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="javascript:;">新建优惠券发放</a></li>
    </ul><br/>
    <form:form id="inputForm" modelAttribute="couponGroup" action="${ctx}/coupon/couponSend/saveCouponGroupInfo" method="post" class="form-horizontal">
        <sys:message content="${message}"/>     
            <input type="hidden" name="couponGroupId" value="${couponGroup.couponGroupId}"/>
        <div class="control-group">
            <label class="control-label">*优惠券名称：</label>
            <div class="controls">
                <form:input id="couponGroupName" path="couponGroupName" value="${couponGroup.couponGroupName}" htmlEscape="false" maxlength="10"  class="input-xlarge "/>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group" id="danUser" style="display: none;">
            <label class="control-label">*单个用户：</label>
            <div class="controls">
                <form:textarea path="singletonUser" value="${couponGroup.singletonUser}" htmlEscape="false"  class="input-xlarge "/>
	...
	<c:forEach items="${couponList}" var="coupon" varStatus="tfdAcc">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:radiobutton path="isSendMessage" value="1"  id="radio1" checked="true"  htmlEscape="false"  maxlength="4" class="input-xlarge "/>是
