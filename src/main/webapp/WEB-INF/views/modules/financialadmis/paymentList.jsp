	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnExport").click(function(){
				var ex = $("#searchForm").attr("action","${ctx}/financialadmis/tradeMoney/exportPayment");
				ex.submit();
				$("#searchForm").attr("action","${ctx}/financialadmis/tradeMoney/paymentList");
			});
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/financialadmis/tradeMoney/">回款列表</a></li>
	</ul>
	<form id="searchForm"  action="${ctx}/financialadmis/tradeMoney/paymentList/" method="post" class="breadcrumb form-search">
