...
<body>
	...
	<div class="footer">
		<!-- Copyright -->汇中网 &copy; 2016-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - ${fns:getConfig('version')}
	</div>
