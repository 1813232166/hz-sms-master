...
<script src="${ctxStatic}/jquery/layer/layer.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/hzwd.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/hzwd.js" type="text/javascript"></script>
