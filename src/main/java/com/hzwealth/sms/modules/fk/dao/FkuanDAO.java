package com.hzwealth.sms.modules.fk.dao;
...
public interface FkuanDAO {
	...
	public List<Borrow1> getBorrowTimeAndAnount(String borrowId);

	public int updateBorrowTime(HashMap<String, Object> map);
