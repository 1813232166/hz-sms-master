 ...
 * @version 2017-06-06
 */
public class ExcelActivityInfo extends DataEntity<ExcelActivityInfo> {
	...
	private Date createTime;		// 创建时间格式yyyy-MM-dd hh:mm:ss
	...
	public ExcelActivityInfo() {
		super();
	}

	public ExcelActivityInfo(String id){
		super(id);
	}
	...
	public String getActivitystatus() {
		...
		}else if ("4".equals(activitystatus))  {
			return  "已结束";
		}else if ("5".equals(activitystatus))  {
			return  "已撤销";
		}
		else {
			return  "";
