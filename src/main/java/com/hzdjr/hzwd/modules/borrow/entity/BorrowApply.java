 ...
 * @version 2016-11-29
 */
public class BorrowApply extends DataEntity<BorrowApply> {
	...
	private String borrowamountLow;		// 最低还款金额
	private String anualrate;		// 年利率
	private String borrowamountHigh;		// 最高还款金额
	...
	@ExcelField(title="申请编号",type=1,align=2,sort=10)
	...
	public String getBorrowamountLow() {
		return borrowamountLow;
	}

	public void setBorrowamountLow(String borrowamountLow) {
	...
	public String getBorrowamountHigh() {
		return borrowamountHigh;
	}

	public void setBorrowamountHigh(String borrowamountHigh) {
	...
	@ExcelField(title="申请状态",type=1,align=2,sort=70)
	public String getBorrowstatus() {
		
		return BorrowStatus.getNameByCode(borrowstatus);
	}
	...
	@ExcelField(title="申请时间",type=1,align=2,sort=60)
	...
	@ExcelField(title="公积金账号",type=1,align=2,sort=40)
