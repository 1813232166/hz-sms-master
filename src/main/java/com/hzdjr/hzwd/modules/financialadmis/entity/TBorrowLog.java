 ...
 * @version 2016-10-19
 */
public class TBorrowLog extends DataEntity<TBorrowLog> {
	...
	private String borrowstatus;		// 状态(0未匹配1预发布;2初审成功;3初审失败;4招标中;5已经满标;6复审失败;7还款中;8已还清;9已流标;10逾期;11已经满标)
	...
	@Length(min=0, max=10, message="状态(0未匹配1预发布;2初审成功;3初审失败;4招标中;5已经满标;6复审失败;7还款中;8已还清;9已流标;10逾期;11已经满标)长度必须介于 0 和 10 之间")
	...
	@Length(min=0, max=30, message="标的中文别名编号长度必须介于 0 和 30 之间")
