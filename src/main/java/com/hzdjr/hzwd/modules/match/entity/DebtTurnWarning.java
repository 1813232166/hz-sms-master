 ...
 * @version 2017-06-19
 */
public class DebtTurnWarning extends DataEntity<DebtTurnWarning> {
	...
	private String assetSource;		// 资产来源 0：PC1：APP2：M站
	
	private String warningDay;		// 预警天数
	...
	private String warningDayLow;//最低预警天数
	private String warningDayHigh;//最高预警天数
	
	public DebtTurnWarning() {
		super();
	}

	public DebtTurnWarning(String id){
		super(id);
	}
	...
	public String getWarningDayLow() {
		return warningDayLow;
	}

	public void setWarningDayLow(String warningDayLow) {
		this.warningDayLow = warningDayLow;
	}

	public String getWarningDayHigh() {
		return warningDayHigh;
	}

	public void setWarningDayHigh(String warningDayHigh) {
		this.warningDayHigh = warningDayHigh;
	}
